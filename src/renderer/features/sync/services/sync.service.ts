...
function toBridgeConfig(syncConfig: SyncSettings): Record<string, unknown> {
  return toSerializableValue(normalizeSyncConfig(syncConfig)) as unknown as Record<string, unknown>;
}
