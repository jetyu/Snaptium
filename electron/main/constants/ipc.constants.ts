export const IPC_CHANNELS = {
  ...
  QUICK_CAPTURE_READY: 'quick-capture:ready',
  QUICK_CAPTURE_REQUESTED: 'quick-capture:requested',
  ...
  KNOWLEDGE_COPILOT_INITIALIZE: 'knowledge-copilot:initialize',
  KNOWLEDGE_COPILOT_REBUILD_INDEX: 'knowledge-copilot:rebuild-index',
  KNOWLEDGE_COPILOT_RUN_TASK: 'knowledge-copilot:run-task',
  ...
  SETTINGS_CONFIRM_KNOWLEDGE_COPILOT_CHUNK_REBUILD: 'settings:confirm-knowledge-copilot-chunk-rebuild',
  SETTINGS_CONFIRM_KNOWLEDGE_COPILOT_REBUILD_MODE: 'settings:confirm-knowledge-copilot-rebuild-mode',
  ...
  SHORTCUTS_GET_GLOBAL_STATUS: 'shortcuts:get-global-status',
