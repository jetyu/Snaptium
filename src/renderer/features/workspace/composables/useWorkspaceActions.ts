...
export function useWorkspaceActions() {
  ...
  const deleteActiveNote = async () => {
    ...
    try {
      ...
      workspaceActionsLogger.error(`Failed to delete note: ${getErrorMessage(error)}`);
      return false;
    }
  };
  ...
  const renameActiveNote = async () => {
    ...
    try {
      ...
      workspaceActionsLogger.error(`Failed to rename note: ${getErrorMessage(error)}`);
      return false;
    }
  };
  ...
  const saveActiveNote = async () => {
    try {
      ...
      workspaceActionsLogger.error(`Failed to save note: ${getErrorMessage(error)}`);
      return false;
    }
  };
