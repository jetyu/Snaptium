        ...
        <div class="settings-grid">
            <section class="setting-card">
                <div class="setting-copy">
                    ...
                    <p class="setting-description">
                        {{ t('text.noteStorageLocation') }}{{ settingsStore.config.noteSavePath }}</p>
                </div>
            ...
            <section class="setting-card">
                ...
                <label class="select-shell" :class="{ 'disabled-shell': maxHistoryVersions === 0 }">
                    <select class="settings-select small-select" :value="snapshotInterval"
                        :disabled="maxHistoryVersions === 0" @change="handleSnapshotIntervalChange">
