...
function normalizeHostAndPort(hostname, port) {
...
export function normalizeTrustedRemoteImageHost(value) {
...
export function normalizeTrustedRemoteImageHosts(values, fallback = DEFAULT_TRUSTED_REMOTE_IMAGE_HOSTS) {
...
function splitHostAndPort(hostPattern) {
...
function matchesTrustedHostPattern(hostname, port, hostPattern) {
...
export function isTrustedRemoteImageUrl(value, trustedHosts = DEFAULT_TRUSTED_REMOTE_IMAGE_HOSTS) {
  try {
