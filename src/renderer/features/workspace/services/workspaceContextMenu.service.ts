...
export function createWorkspaceContextMenuLabels(t: Translate) {
  return {
    ...
    [WORKSPACE_CONSTANTS.MENU.READ_MODE]: t(WORKSPACE_CONSTANTS.MENU.READ_MODE),
    [WORKSPACE_CONSTANTS.MENU.EDIT_MODE]: t(WORKSPACE_CONSTANTS.MENU.EDIT_MODE),
    [WORKSPACE_CONSTANTS.MENU.EXPORT_PDF]: t(WORKSPACE_CONSTANTS.MENU.EXPORT_PDF),
...
export function getNoteContextMenu(note: Note, moveTargets: WorkspaceMoveTarget[] = []): WorkspaceMenuItem[] {
  ...
  return [
    { action: WORKSPACE_CONSTANTS.ACTIONS.TOGGLE_READ_MODE, labelKey: note.locked ? WORKSPACE_CONSTANTS.MENU.EDIT_MODE : WORKSPACE_CONSTANTS.MENU.READ_MODE },
    ...
    { action: WORKSPACE_CONSTANTS.ACTIONS.EXPORT_PDF, labelKey: WORKSPACE_CONSTANTS.MENU.EXPORT_PDF },
