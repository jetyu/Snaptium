export const IPC_CHANNELS = {
  ...
  KNOWLEDGE_AGENT_ANSWER_QUESTION_STREAM: 'knowledge-agent:answer-question-stream',
  KNOWLEDGE_AGENT_ANSWER_QUESTION_STREAM_EVENT: 'knowledge-agent:answer-question-stream-event',
