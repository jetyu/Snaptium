...
function buildStylePrompt(style: AiWritingStyle): string {
...
export function buildAiAssistantSystemPrompt(
  style: AiWritingStyle = AI_WRITING_DEFAULTS.STYLE,
  scenario: AiWritingScenario = AI_WRITING_DEFAULTS.SCENARIO
): string {
